            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="glass-card rounded-2xl p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-muted-foreground">Start hosting game servers in minutes</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex items-start gap-2">
                            <input
                                ...
                                className="mt-1 h-4 w-4 rounded border-border bg-muted/30 text-primary-500 focus:ring-primary-500/50"
                            />
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button className="flex items-center justify-center gap-2 py-2.5 rounded-lg border border-border/50 text-foreground hover:bg-muted/50 transition-colors">
